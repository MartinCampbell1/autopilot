...
from autopilot.core.account_diagnostics import build_account_diagnostics_snapshot, load_account_probe_state
...
class _FakeAdapter:
    ...
    def test_environment(self, profile: Profile, *, env, timeout: int) -> AdapterProbeResult:
